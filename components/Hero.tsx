...
//     {/* Animated Car */}
//     <div ref={carRef} className="absolute bottom-20 z-20 pointer-events-none">
//       <Image
//         src="/BeloCar.png"
//         alt="Car Animation"
//         width={100}
...
//         filter: "drop-shadow(0 35px 70px rgba(0,0,0,0.95))",
//       }}
//     >
//       <Image
...
//         className="relative"
//         style={{
//           transform: `rotateX(${BILLBOARD_CONFIG.tiltX}deg) rotateY(${BILLBOARD_CONFIG.tiltY}deg) rotateZ(${BILLBOARD_CONFIG.tiltZ}deg) scale(${BILLBOARD_CONFIG.scale})`,
//         }}
//       >
//         {/* Billboard panel */}
//         <div
//           className="z-20 relative bg-gradient-to-br from-slate-800 via-slate-900 to-black rounded-xl overflow-hidden"
//           style={{
...
//                   color: "#ffffff",
//                   textShadow:
//                     "0 2px 10px rgba(196,30,58,0.5), 0 0 20px rgba(196,30,58,0.3)",
